...
def run_simpll(first, second, fun_first, fun_second, var, var_value=None,
               var_indices=None, suffix=None, cache_dir=None,
               control_flow_only=False, output_llvm_ir=False,
               print_asm_diffs=False, verbose=False, use_ffi=False,
               no_missing_def=False, module_cache=None):
    """
        ...
        try:
            ...
            if var_indices:
                for var_index in var_indices:
                    simpll_command.extend(["--var-index", str(var_index)])
            ...
            if no_missing_def:
                simpll_command.append("--no-missing-defs-in-preprocess")
